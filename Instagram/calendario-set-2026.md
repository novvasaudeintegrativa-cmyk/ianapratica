...
**Automação real:** 13 tarefas criadas no Windows Task Scheduler
(`IANaPratica-F02` a `IANaPratica-F08`, ver `scripts/setup-tasks-instagram.ps1`)
— cada uma dispara `publish_instagram.py` sozinha na data/hora certa, sem
precisar de pedido. F08 teve o placeholder de prova social removido da
legenda (sem dado real disponível).
