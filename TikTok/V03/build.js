// TikTok/V08 — headline 4 ("Vale a pena usar o Claude Code?") desenvolvida
// em 5 slides. Mesmo padrão fixo do V05 (ver TikTok/calendario-set-2026.md):
//   - Fundo alterna dark/claro por slide (ímpar=escuro, par=claro).
//   - Cor de abóbora (#E94F00) sempre que o texto disser "Claude Code" ou
...
const SLIDES = [
  { idx: "01", theme: "dark",  duration: 4.6, cta: false, text: "Vale a pena usar<br>o <span class=\"accent\">Claude Code</span>?" },
  { idx: "02", theme: "light", duration: 4.6, cta: false, text: "Ele faz em minutos<br>o que levava horas" },
  { idx: "03", theme: "dark",  duration: 4.6, cta: false, text: "Custa muito menos que<br>uma agência ou freelancer" },
  { idx: "04", theme: "light", duration: 4.6, cta: false, text: "Seu <span class=\"accent\">Instagram</span> posta<br>sozinho, com qualidade" },
