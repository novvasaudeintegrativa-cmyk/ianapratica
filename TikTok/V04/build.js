// TikTok/V09 — headline 5 ("Dá pra conectar o Claude no Instagram?") em 5
// slides. Mesmo padrão fixo do V05 (ver TikTok/calendario-set-2026.md).
const fs = require("fs");
...
const SLIDES = [
  { idx: "01", theme: "dark",  duration: 4.6, cta: false, text: "Dá pra conectar o<br><span class=\"accent\">Claude</span> no <span class=\"accent\">Instagram</span>?" },
  { idx: "02", theme: "light", duration: 4.6, cta: false, text: "Sim — direto pela<br>API oficial" },
  { idx: "03", theme: "dark",  duration: 4.6, cta: false, text: "Ele publica post,<br>carrossel e Stories<br>sozinho" },
  { idx: "04", theme: "light", duration: 4.6, cta: false, text: "Sem precisar abrir o<br>Meta Business Suite" },
